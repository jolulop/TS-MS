...
1. `docs/specification-index-v5.6.md`
2. `docs/functional-spec-v5.6.md`
3. `docs/use-cases-acceptance-v5.6.md`
4. `docs/data-model-erd-v5.6.md`
5. `docs/authorization-matrix-v5.6.md`
6. `docs/ui-screen-spec-v5.6.md`
7. `docs/integration-api-spec-v5.6.md`
8. `docs/business-rules-catalog-v5.6.md`
9. `docs/non-functional-requirements-v5.6.md`

Legacy `v5.2`, `v5.4`, and `v5.5` markdown notes in `docs/` are historical only and are not the current implementation source of truth.
