...
def _serialize_current_user(current_user) -> dict:
    return {
        "employee": {
            ...
            "office": {
                "id": current_user.office_id,
                "office_name": current_user.office_name,
                "status": current_user.office_status,
            },
...
def _serialize_employee(employee: Employee) -> dict:
    ...
    return {
        ...
        "office": {
            ...
            "status": employee.office.status.value_code,
        },
        "roles": role_codes,
...
def list_employees(request: HttpRequest) -> JsonResponse:
    ...
    employees = (
        Employee.objects.select_related(
            "primary_business_unit", "status", "office", "office__status"
        )
...
def employee_detail(request: HttpRequest, employee_id: int) -> JsonResponse:
    try:
        ...
        employee = (
            ...
            .select_related("office", "office__status")
