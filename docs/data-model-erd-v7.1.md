...
Summarize the approved v7.1 logical data model and point to the detailed
...
- v7.1 includes approved logical support for dedicated cross-office staffing on
...
and the v7.1 markdown set as the approved source-of-truth reference.
