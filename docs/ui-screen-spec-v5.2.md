...
Superseded by [ui-screen-spec-v5.8.md](/home/jolulop/code/TS-MS/docs/ui-screen-spec-v5.8.md).
...
It originally targeted the legacy v5.1 UI screen specification and is preserved here only as a historical delta.
