...
- No structural schema changes were introduced in the UI consolidation promoted in v5.5.
...
When model behavior and older doc versions differ, treat the current diagram and the v5.5 markdown set as the repository-aligned reference.
