...
- No structural schema changes were introduced in the v5.9.3 promotion itself;
...
When model behavior and older doc versions differ, treat the current diagram and the v5.9.3 markdown set as the repository-aligned reference.
