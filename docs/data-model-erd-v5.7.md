...
- No structural schema changes were introduced in the v5.7 promotion itself; the release documents the already-implemented approval oversight, report export, and UI refinements.
...
When model behavior and older doc versions differ, treat the current diagram and the v5.7 markdown set as the repository-aligned reference.
