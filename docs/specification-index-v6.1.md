# Specification Index v6.1

## Purpose

This markdown set is the current approved v6.1 source-of-truth specification
for the Timesheet Management System as of `2026-05-23`.
...
- [functional-spec-v6.1.md](/home/jolulop/code/TS-MS/docs/functional-spec-v6.1.md)
- [ui-screen-spec-v6.1.md](/home/jolulop/code/TS-MS/docs/ui-screen-spec-v6.1.md)
- [integration-api-spec-v6.1.md](/home/jolulop/code/TS-MS/docs/integration-api-spec-v6.1.md)
- [authorization-matrix-v6.1.md](/home/jolulop/code/TS-MS/docs/authorization-matrix-v6.1.md)
- [business-rules-catalog-v6.1.md](/home/jolulop/code/TS-MS/docs/business-rules-catalog-v6.1.md)
- [use-cases-acceptance-v6.1.md](/home/jolulop/code/TS-MS/docs/use-cases-acceptance-v6.1.md)
- [non-functional-requirements-v6.1.md](/home/jolulop/code/TS-MS/docs/non-functional-requirements-v6.1.md)
- [data-model-erd-v6.1.md](/home/jolulop/code/TS-MS/docs/data-model-erd-v6.1.md)
- [database-schema-diagram.md](/home/jolulop/code/TS-MS/docs/database-schema-diagram.md)

## Version Notes

v6.1 captures these major baseline changes relative to the older docs:
...
- v6.1 also approves a dedicated `Cross-Office Staffing` model alongside
