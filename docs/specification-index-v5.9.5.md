# Specification Index v5.9.5

## Purpose

This markdown set is the current repository-aligned specification for the implemented Timesheet Management System as of `2026-05-21`.
...
- [functional-spec-v5.9.5.md](/home/jolulop/code/TS-MS/docs/functional-spec-v5.9.5.md)
- [ui-screen-spec-v5.9.5.md](/home/jolulop/code/TS-MS/docs/ui-screen-spec-v5.9.5.md)
- [integration-api-spec-v5.9.5.md](/home/jolulop/code/TS-MS/docs/integration-api-spec-v5.9.5.md)
- [authorization-matrix-v5.9.5.md](/home/jolulop/code/TS-MS/docs/authorization-matrix-v5.9.5.md)
- [business-rules-catalog-v5.9.5.md](/home/jolulop/code/TS-MS/docs/business-rules-catalog-v5.9.5.md)
- [use-cases-acceptance-v5.9.5.md](/home/jolulop/code/TS-MS/docs/use-cases-acceptance-v5.9.5.md)
- [non-functional-requirements-v5.9.5.md](/home/jolulop/code/TS-MS/docs/non-functional-requirements-v5.9.5.md)
- [data-model-erd-v5.9.5.md](/home/jolulop/code/TS-MS/docs/data-model-erd-v5.9.5.md)
- [database-schema-diagram.md](/home/jolulop/code/TS-MS/docs/database-schema-diagram.md)

## Version Notes

v5.9.5 captures these major implemented changes relative to the older baseline docs:
