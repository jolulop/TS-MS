# UI Screen Specification v7.1

## 1. Purpose

Describe the approved v7.1 server-rendered UI screens and behaviors for the
repository baseline.
...
- Collection:
  ...
  - create employee selector is narrowed dynamically to active employees in the
    selected project's Business Unit; normal Project Assignment creation also
    rejects employees who are not active in the selected project's Business Unit
