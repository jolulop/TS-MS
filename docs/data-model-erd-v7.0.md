...
Summarize the approved v7.0 logical data model and point to the detailed
...
- v7.0 adds approved logical support for dedicated cross-office staffing on
...
and the v7.0 markdown set as the approved source-of-truth reference.
