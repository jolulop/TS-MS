# Specification Index v7.1

## Purpose

This markdown set is the current approved v7.1 source-of-truth specification
...
- [functional-spec-v7.1.md](/home/jolulop/code/TS-MS/docs/functional-spec-v7.1.md)
- [ui-screen-spec-v7.1.md](/home/jolulop/code/TS-MS/docs/ui-screen-spec-v7.1.md)
- [integration-api-spec-v7.1.md](/home/jolulop/code/TS-MS/docs/integration-api-spec-v7.1.md)
- [authorization-matrix-v7.1.md](/home/jolulop/code/TS-MS/docs/authorization-matrix-v7.1.md)
- [business-rules-catalog-v7.1.md](/home/jolulop/code/TS-MS/docs/business-rules-catalog-v7.1.md)
- [use-cases-acceptance-v7.1.md](/home/jolulop/code/TS-MS/docs/use-cases-acceptance-v7.1.md)
- [non-functional-requirements-v7.1.md](/home/jolulop/code/TS-MS/docs/non-functional-requirements-v7.1.md)
- [data-model-erd-v7.1.md](/home/jolulop/code/TS-MS/docs/data-model-erd-v7.1.md)
- [database-schema-diagram.md](/home/jolulop/code/TS-MS/docs/database-schema-diagram.md)

## Version Notes

v7.1 promotes the current code-aligned source-of-truth set and adds these
clarifications relative to v7.0:
...
The v7.1 baseline also carries forward these major approved behaviors from
the older docs:
...
- v7.1 includes the dedicated `Cross-Office Staffing` model alongside
