# Specification Index v7.0

## Purpose

This markdown set is the current approved v7.0 source-of-truth specification
for the Timesheet Management System as of `2026-05-25`.
...
- [functional-spec-v7.0.md](/home/jolulop/code/TS-MS/docs/functional-spec-v7.0.md)
- [ui-screen-spec-v7.0.md](/home/jolulop/code/TS-MS/docs/ui-screen-spec-v7.0.md)
- [integration-api-spec-v7.0.md](/home/jolulop/code/TS-MS/docs/integration-api-spec-v7.0.md)
- [authorization-matrix-v7.0.md](/home/jolulop/code/TS-MS/docs/authorization-matrix-v7.0.md)
- [business-rules-catalog-v7.0.md](/home/jolulop/code/TS-MS/docs/business-rules-catalog-v7.0.md)
- [use-cases-acceptance-v7.0.md](/home/jolulop/code/TS-MS/docs/use-cases-acceptance-v7.0.md)
- [non-functional-requirements-v7.0.md](/home/jolulop/code/TS-MS/docs/non-functional-requirements-v7.0.md)
- [data-model-erd-v7.0.md](/home/jolulop/code/TS-MS/docs/data-model-erd-v7.0.md)
- [database-schema-diagram.md](/home/jolulop/code/TS-MS/docs/database-schema-diagram.md)

## Version Notes

v7.0 captures these major baseline changes relative to the older docs:
...
- v7.0 also approves a dedicated `Cross-Office Staffing` model alongside
