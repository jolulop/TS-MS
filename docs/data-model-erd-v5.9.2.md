...
- No structural schema changes were introduced in the v5.9.2 promotion itself;
  the release documents the latest admin API parity, reporting, and General
  Charge Code routing-governance behavior on top of the existing model.
...
When model behavior and older doc versions differ, treat the current diagram and the v5.9.2 markdown set as the repository-aligned reference.
