# Integration API Specification v6.0

## 1. Purpose

Describe the currently implemented JSON API surface under `/api/v1`.

No JSON API versioning change was introduced in the v6.0 documentation promotion. The main implemented deltas in the current surface are:
