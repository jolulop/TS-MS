...
- Collection:
  ...
  - create/edit employee selector is limited to employees in the administrator's
    active Business Unit scope; normal Project Assignment creation additionally
