...
| Open Cross-Office Staffing | No | Yes, owned target projects only | Yes, managed target projects only | Yes, scoped target projects | No |
| Open Cross-Office Staffing Detail | No | Yes, owned target projects only | Yes, managed target projects only | Yes, scoped target projects | No |
| Manage Cross-Office Staffing | No | Yes, owned target projects only | Yes, managed target projects only | Yes, scoped target projects | No |
...
- can create, edit, and delete cross-office staffing only for owned target
  projects
...
- can create, edit, and delete cross-office staffing only for managed target
  projects
...
- can open and manage cross-office staffing for scoped target projects
...
- Cross-office staffing authority follows the target project scope rather than
  the employee origin Office.
...
- Any future target-project-Office `TS_ADMIN` oversight expansion is a
