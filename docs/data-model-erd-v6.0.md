...
Summarize the approved v6.0 logical data model and point to the detailed
...
- v6.0 adds approved logical support for dedicated cross-office staffing on
...
and the v6.0 markdown set as the approved source-of-truth reference.
